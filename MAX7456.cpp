...
// Public Methods //////////////////////////////////////////////////////////////
                  ...
                  ) 
  {
    ...
    *deviceSelectPort |= deviceSelectMask;      // Leave pin high (slave is  
    ...
    clear( MAX7456_OSDBL_W, 1 << MAX7456_OSDBL_MAN ); // Set black level control to 
  ...
  void MAX7456::display() 
  {
    ...
    set( MAX7456_VM0_W, 1 << MAX7456_VM0_OSDON ); // Enable display
  }
  // end display()
  ...
  void MAX7456::noDisplay() 
  {
    ...
    clear( MAX7456_VM0_W, 1 << MAX7456_VM0_OSDON ); // Disable display.
  }
  // end noDisplay()
  ...
  void MAX7456::video() 
  {
    ...
    clear( MAX7456_VM0_W, 1 << MAX7456_VM0_BUFOFF ); // Enable video.
  }
  // end video()
  ...
  void MAX7456::noVideo() 
  {
    ...
    set( MAX7456_VM0_W, 1 << MAX7456_VM0_BUFOFF ); // Disable video.
  }
  // end noVideo()
  ...
  bool MAX7456::resetIsBusy() 
  {
    ...
    clear( MAX7456_OSDBL_W, 1 << MAX7456_OSDBL_MAN ); // Reset black level control 
  ...
  void MAX7456::clear() 
  {
    ...
    set( MAX7456_DMM_W, 1 << MAX7456_DMM_CDM ); // Begins display clearing.
  }
  // end clear()
                  ...
                  ) 
  {
    ...
    {
      uint8_t bits = 1 << MAX7456_VM0_FIXSYNC | 1 << MAX7456_VM0_INTSYNC;
      set( MAX7456_VM0_W, bits );
    }
    else if (sync == MAX7456_EXTSYNC)
    {
      uint8_t mask = 1 << MAX7456_VM0_FIXSYNC | 1 << MAX7456_VM0_INTSYNC;
      uint8_t bits = 1 << MAX7456_VM0_FIXSYNC;
      send( MAX7456_VM0_W, bits, mask );
    }
    else if (sync == MAX7456_AUTOSYNC)
    {
      uint8_t mask = 1 << MAX7456_VM0_FIXSYNC | 1 << MAX7456_VM0_INTSYNC;
      uint8_t bits = 1 << MAX7456_VM0_INTSYNC;
      send( MAX7456_VM0_W, bits, mask );
    }
    else
    {
                  ...
                  ) 
  {
    ...
    {
      set( MAX7456_VM0_W, 1 << MAX7456_VM0_PAL ); // Set the video system to PAL.
      
      defaultSystem = system;
    }
    if (system == MAX7456_NTSC)
    {
      clear( MAX7456_VM0_W, 1 << MAX7456_VM0_PAL ); // Set the video system to NTSC.
  ...
  void MAX7456::videoBackground() 
  {
    ...
    clear( MAX7456_DMM_W, 1 << MAX7456_DMM_LBC );
  }
  // end videoBackground()
  ...
  void MAX7456::grayBackground() 
  {
    ...
    set( MAX7456_DMM_W, 1 << MAX7456_DMM_LBC );
  }
  // end grayBackground()
  ...
  void MAX7456::blink() 
  {
    ...
    set( MAX7456_DMM_W, 1 << MAX7456_DMM_BLK );
  }
  // end blink()
  ...
  void MAX7456::noBlink() 
  {
    ...
    clear( MAX7456_DMM_W, 1 << MAX7456_DMM_BLK );
  }
  // end noBlink()
  ...
  void MAX7456::normalColor() 
  {
    ...
    clear( MAX7456_DMM_W, 1 << MAX7456_DMM_INV );
  }
  // end normalColor()
  ...
  void MAX7456::invertColor() 
  {
    ...
    set( MAX7456_DMM_W, 1 << MAX7456_DMM_INV );
  }
  // end invertColor()
...
// Private Methods /////////////////////////////////////////////////////////////
                            ...
                            ) 
  {
    ...
    if (!inAutoIncrement) {                     // If needed,
      noInterrupts();                           // send and note change without 
                                                ...
                                                //   errors with send(),
      set( MAX7456_DMM_W, 1 << MAX7456_DMM_AI ); // reenter autoincrement mode, 
                     ...
                     ) 
  {
    ...
    ubContent = ubContent & ~mask;              // Clear affected bits, and 
  ...
  // Sets the bits in the register at the specified address
                      ...
                      )
  {
    ...
    ubContent = receive(address + MAX7456_RRAO);
    ubContent |= value;
    return send(address, ubContent);
  }

  // Clears teh bits in the register at the specified address
  // where the value is 1
  uint8_t MAX7456::clear(
                       uint8_t address,
                       uint8_t value
                      )
  {
